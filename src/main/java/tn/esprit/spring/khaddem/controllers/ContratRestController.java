...
import tn.esprit.spring.khaddem.mapper.ContratMapper;
...
public class ContratRestController {
    ...
    public Contrat addContrat(@RequestBody ContratDTO c) {
        return contratService.addContrat(ContratMapper.toContrat(c));
    }
    ...
    public Contrat updateEtudiant(@RequestBody ContratDTO cont) {
        return contratService.updateContrat(ContratMapper.toContrat(cont));
    }
    ...
    public Contrat addAndAffectContratToEtudiant(@RequestBody ContratDTO contrat,@PathVariable("nomE") String nomE,@PathVariable("prenomE") String prenomE) {
        return contratService.addAndAffectContratToEtudiant(ContratMapper.toContrat(contrat),nomE,prenomE);
    }
