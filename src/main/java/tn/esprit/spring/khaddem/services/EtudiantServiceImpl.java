...
public class EtudiantServiceImpl implements IEtudiantService{
    ...
    public Etudiant updateEtudiant(Etudiant e) {
        ...
        if (existingEtudiantOptional.isPresent()) {
            ...
            existingEtudiant.setNomE(e.getNomE());
            existingEtudiant.setPrenomE(e.getPrenomE());
            // ...
    ...
    public Etudiant retrieveEtudiant(Integer idEtudiant) {
        return etudiantRepository.findById(idEtudiant).orElseThrow(() -> new NoSuchElementException("L'élément n'a pas été trouvé")); // Utilisation de orElseThrow avec exception personnalisée
    }
    ...
    public void assignEtudiantToDepartement(Integer etudiantId, Integer departementId) {
        ...
        if (etudiantOptional.isPresent() && departementOptional.isPresent()) {
            ...
            // Gérer le cas où l'Optional est vide (par exemple, en lançant une exception ou en effectuant une autre action appropriée).
        }
    }
    ...
    public List<Etudiant> getEtudiantsByDepartement(Integer idDepartement) {
        ...
        if (departementOptional.isPresent()) {
            ...
            // Gérer le cas où l'Optional est vide (par exemple, en retournant une liste vide ou en lançant une exception).
            return Collections.emptyList(); // Exemple : retourner une liste vide
        }
    }
}
